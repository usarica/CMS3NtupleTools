...
#define OVERLAPMAP_EGAMMAS_AK4JETS_LINKED_VARIABLES \
...
#define OVERLAPMAP_ELECTRONS_AK4JETS_UNLINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_UNLINKED_VARIABLES
#define OVERLAPMAP_ELECTRONS_AK4JETS_LINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_LINKED_VARIABLES \
OVERLAPMAP_EGAMMAS_AK4JETS_LINKED_VARIABLES
#define OVERLAPMAP_ELECTRONS_AK4JETS_VARIABLES \
OVERLAPMAP_ELECTRONS_AK4JETS_UNLINKED_VARIABLES \
OVERLAPMAP_ELECTRONS_AK4JETS_LINKED_VARIABLES

#define OVERLAPMAP_ELECTRONS_AK8JETS_UNLINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_UNLINKED_VARIABLES
#define OVERLAPMAP_ELECTRONS_AK8JETS_LINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_LINKED_VARIABLES
#define OVERLAPMAP_ELECTRONS_AK8JETS_VARIABLES \
OVERLAPMAP_ELECTRONS_AK8JETS_UNLINKED_VARIABLES \
OVERLAPMAP_ELECTRONS_AK8JETS_LINKED_VARIABLES

#define OVERLAPMAP_PHOTONS_AK4JETS_UNLINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_UNLINKED_VARIABLES
#define OVERLAPMAP_PHOTONS_AK4JETS_LINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_LINKED_VARIABLES \
OVERLAPMAP_EGAMMAS_AK4JETS_LINKED_VARIABLES
#define OVERLAPMAP_PHOTONS_AK4JETS_VARIABLES \
OVERLAPMAP_PHOTONS_AK4JETS_UNLINKED_VARIABLES \
OVERLAPMAP_PHOTONS_AK4JETS_LINKED_VARIABLES

#define OVERLAPMAP_PHOTONS_AK8JETS_UNLINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_UNLINKED_VARIABLES
#define OVERLAPMAP_PHOTONS_AK8JETS_LINKED_VARIABLES \
OVERLAPMAP_PARTICLES_JETS_LINKED_VARIABLES
#define OVERLAPMAP_PHOTONS_AK8JETS_VARIABLES \
OVERLAPMAP_PHOTONS_AK8JETS_UNLINKED_VARIABLES \
