...
void SampleHelpers::constructSamplesList(TString const& sname, SystematicsHelpers::SystematicVariationTypes syst, std::vector<TString>& samples){
  ...
  if (theDataYear == 2018){
    ...
    if (sname == "ZGJets_nunu_nlo_pTG_130-inf" || sname == "ZGJets_nlo") HelperFunctions::appendVector<TString>(samples, std::vector<TString>{ "/ZGTo2NuG_PtG-130_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM" });
    // if (sname == "ZGJets_nunu_nlo_incl" || sname == "ZGJets_nlo") HelperFunctions::appendVector<TString>(samples, std::vector<TString>{ "/ZGTo2NuG_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM" });
    if (sname == "ZGJets_ll_nlo_pTG_130-inf" || sname == "ZGJets_nlo") HelperFunctions::appendVector<TString>(samples, std::vector<TString>{ "ZGTo2LG_PtG-130_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM" });
