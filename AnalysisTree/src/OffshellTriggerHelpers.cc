...
void OffshellTriggerHelpers::configureHLTmap(){
  ...
  case 2016:
    ...
    HLT_type_proplist_map[kSingleMu] = std::vector<HLTTriggerPathProperties>{ { "HLT_IsoMu20_v*" }, { "HLT_IsoTkMu20_v*" }, { "HLT_IsoMu22_v*" }, { "HLT_IsoTkMu22_v*" }, { "HLT_IsoMu24_v*" }, { "HLT_IsoTkMu24_v*" } };
    HLT_type_proplist_map[kSingleEle] = std::vector<HLTTriggerPathProperties>{ { "HLT_Ele25_eta2p1_WPTight_Gsf_v*" }, { "HLT_Ele27_WPTight_Gsf_v*" }, { "HLT_Ele27_eta2p1_WPLoose_Gsf_v*" }, { "HLT_Ele32_eta2p1_WPTight_Gsf_v*" } };
    ...
    break;
  case 2017:
    HLT_type_proplist_map[kDoubleMu] = std::vector<HLTTriggerPathProperties>{ { "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v*" }, { "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v*" } };
    HLT_type_proplist_map[kDoubleEle] = std::vector<HLTTriggerPathProperties>{ { "HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v*" }, { "HLT_DoubleEle33_CaloIdL_MW_v*" } };
    HLT_type_proplist_map[kMuEle] = std::vector<HLTTriggerPathProperties>{
      { "HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v*" }, { "HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v*" },
      { "HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v*" }, { "HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v*" }
    };
    HLT_type_proplist_map[kSingleMu] = std::vector<HLTTriggerPathProperties>{ { "HLT_IsoMu27_v*" } };
    HLT_type_proplist_map[kSingleEle] = std::vector<HLTTriggerPathProperties>{ { "HLT_Ele35_WPTight_Gsf_v*" }, { "HLT_Ele38_WPTight_Gsf_v*" }, { "HLT_Ele40_WPTight_Gsf_v*" } };
    HLT_type_proplist_map[kSinglePho] = std::vector<HLTTriggerPathProperties>{
  ...
  case 2018:
    ...
    HLT_type_proplist_map[kSingleMu] = std::vector<HLTTriggerPathProperties>{ { "HLT_IsoMu24_v*" } };
    HLT_type_proplist_map[kSingleEle] = std::vector<HLTTriggerPathProperties>{ { "HLT_Ele32_WPTight_Gsf_v*" } };
    HLT_type_proplist_map[kSinglePho] = std::vector<HLTTriggerPathProperties>{
