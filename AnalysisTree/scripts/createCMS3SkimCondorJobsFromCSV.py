...
class BatchManager:
   def __init__(self):
      ...
      self.parser.add_option("--nfilesperjob_MC", type="int", default=25, help="Approximate number of input files per MC skim job")
      self.parser.add_option("--nfilesperjob_data", type="int", default=40, help="Approximate number of input files per data skim job")
