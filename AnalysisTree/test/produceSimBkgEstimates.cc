...
#define _JETMETARGS_ applyPUIdToAK4Jets, applyTightLeptonVetoIdToAK4Jets, use_MET_Puppi, use_MET_XYCorr, use_MET_JERCorr, use_MET_ParticleMomCorr, use_MET_p4Preservation, use_MET_corrections
  ...
  for (auto const& sgroup:sgroups){
    ...
    tout->putBranch<unsigned int>("n_ak8jets_pt200_mass60to110", 0); // Number of ak4 jets with pT>=200 GeV AND mass within [60, 110) GeV (inclusive/exclusive range)
    tout->putBranch<unsigned int>("n_ak8jets_pt200_mass140", 0); // Number of ak4 jets with pT>=200 GeV AND mass>=140 GeV
