...
# NOTE 1. If you want to use the "central" files, remove "/user/usarica/localcache".
...
#     inputs=/store/user/usarica/localcache/mc/RunIISummer16MiniAODv2/TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/70000/1C8BFCBE-26B6-E611-80E5-A0000420FE80.root \
#     nevents=-1
...
$cmd $pset dumpProcess=True globaltag=94X_mcRun2_asymptotic_v3 nevents=$nevents \
    inputs=/store/user/usarica/localcache/mc/RunIISummer16MiniAODv2/TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/70000/1C8BFCBE-26B6-E611-80E5-A0000420FE80.root \
    minNleptons=2 minNphotons=1 includeLJetsSelection=True keepExtraSuperclusters=True doTrigObjMatching=True triggerListFromFile=OffshellTriggerFilterList_2016.lst \
...
#    inputs=/store/user/usarica/localcache/mc/RunIISpring16MiniAODv2/SMS-T1tttt_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUSpring16Fast_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/00000/5A5E2A72-4F2D-E611-B2F5-02163E017638.root \
#    minNleptons=2 minNphotons=1 includeLJetsSelection=True keepExtraSuperclusters=True doTrigObjMatching=True triggerListFromFile=OffshellTriggerFilterList_2016.lst \
...
$cmd $pset dumpProcess=True globaltag=94X_dataRun2_v10 nevents=$nevents \
    goldenjson=Cert_271036-284044_13TeV_ReReco_07Aug2017_Collisions16_JSON.txt \
    inputs=/store/user/usarica/localcache/data/Run2016C/DoubleMuon/MINIAOD/17Jul2018-v1/50000/D229CC30-1E8B-E811-844A-A0369FD0B228.root \
    minNleptons=2 minNphotons=1 includeLJetsSelection=True keepExtraSuperclusters=True doTrigObjMatching=True triggerListFromFile=OffshellTriggerFilterList_2016.lst \
...
$cmd $pset dumpProcess=True globaltag=94X_mcRun2_asymptotic_v3 nevents=$nevents \
    inputs=/store/user/usarica/localcache/mc/RunIISummer16MiniAODv3/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3_ext2-v2/100000/6053E770-34E9-E811-98D2-246E96D10C28.root \
    minNleptons=2 minNphotons=1 includeLJetsSelection=True keepExtraSuperclusters=True doTrigObjMatching=True triggerListFromFile=OffshellTriggerFilterList_2016.lst \
...
$cmd $pset dumpProcess=True globaltag=102X_dataRun2_v13 nevents=$nevents \
    ...
    minNleptons=2 minNphotons=1 includeLJetsSelection=True keepExtraSuperclusters=True doTrigObjMatching=True triggerListFromFile=OffshellTriggerFilterList_2018.lst \
