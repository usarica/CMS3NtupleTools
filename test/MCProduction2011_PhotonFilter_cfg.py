...
# Photon Filter from SDFilter
process.EventSelectionPhotonFilt = cms.PSet(
...
process.out = cms.OutputModule(
        "PoolOutputModule",
        process.EventSelectionPhotonFilt,
...
#
process.cms2WithEverything = cms.Sequence( process.sdFilter * process.ak5PFJets * process.kt6PFJets * process.cms2CoreSequence * process.cms2PFNoTauSequence * process.cms2GENSequence )
