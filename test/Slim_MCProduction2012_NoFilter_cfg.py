...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/nfs-3/userdata/gzevi/patTuple_TTbar.root')
)
...
process.p                  = cms.Path( process.pfCandidateMaker*process.eventMaker*process.electronMaker*process.muonMaker*process.pfJetMaker*process.pfmetMaker)
