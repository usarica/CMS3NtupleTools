...
###Trigger Filter
process.load("CMS2.NtupleMaker.triggerFilter_cfi")
...
process.source = cms.Source("PoolSource",
	...
	# this file is - copied it from elsewhere to cms-tas03 because castor sucks
	# Fall08/TTJets-madgraph/GEN-SIM-RECO/IDEAL_V11_redigi_v10/0010/B493FB91-EA00-DE11-B852-00E081791899.root
	'file:/tmp/B493FB91-EA00-DE11-B852-00E081791899.root')
...
process.out_CMS2 = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ntuple_filered.root')
)
...
process.CMS2Reco      = cms.Sequence(process.electronSequence * process.gammaSequence * process.cms2JetSequence * process.CMS2Btagging * process.metCorSequence)
...
process.p             = cms.Path(process.CMS2Reco * process.cms2 * process.triggerFilter * process.pflowmakers * process.patDefaultSequence * process.patmakers)
