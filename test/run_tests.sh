...
$cmd $pset globaltag=94X_mc2017_realistic_v17 nevents=$nevents metrecipe=True \
...
# 2017 Re-reco Data (with MET recipe v2)
# /DoubleMuon/Run2017C-31Mar2018-v1/MINIAOD
$cmd $pset globaltag=94X_dataRun2_v11 nevents=$nevents metrecipe=True \
...
# 2017 Re-reco Data (Re-Re-Reco of 2017F, so no MET recipe needed)
# /DoubleMuon/Run2017C-31Mar2018-v1/MINIAOD
$cmd $pset globaltag=94X_dataRun2_v11 nevents=$nevents \
