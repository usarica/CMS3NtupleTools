...
process.makers        = cms.Sequence(process.trkmuonfilter*process.muonMaker * process.jetMaker * process.trackMaker * process.scMaker * process.electronSequence * process.JPTCorrections * process.trkjetmaker * process.metCorSequence)

###process.makers        = cms.Sequence(process.muonMaker * process.jetMaker * process.trackMaker * process.scMaker * process.uniqueElectrons * process.JPTCorrections * process.trkjetmaker * process.metCorSequence)
###process.makers        = cms.Sequence(process.muonMaker * process.jetMaker * process.trackMaker * process.scMaker * process.uniqueElectrons * process.JPTCorrections * process.metCorSequence)
