...
process.p = cms.Path(process.JetCorrection*process.JPTCorrection*process.metCorSequence*process.MetCorrection*process.patTuple*process.cms2*process.aSkimFilter)
