 ...
 *
 * $Date: 2009/11/30 22:39:33 $
 * $Revision: 1.1 $
 *
 */

// this class header
#include "CMS2/NtupleMaker/interface/HLTLevel1GTSeed.h"
...
HLTLevel1GTSeed::HLTLevel1GTSeed(const edm::ParameterSet& parSet) :
    ...
    //produces<trigger::TriggerFilterObjectWithRefs>();
        produces<int> ("beamflaggerbeam").setBranchAlias("beamflagger_beam");
...
void HLTLevel1GTSeed::produce(edm::Event& iEvent, const edm::EventSetup& evSetup) {

  std::auto_ptr<int>   beamflagger_beam  ( new int   );
...
//        }
  ...
  if (seedsResult) *beamflagger_beam = 1;
  else *beamflagger_beam = 0;
...
*/
  ...
  iEvent.put(beamflagger_beam, "beamflaggerbeam"    );
