...
{
    auto_ptr<unsigned int>           l1bits1         (new unsigned int);
    auto_ptr<unsigned int>           l1bits2         (new unsigned int);
    auto_ptr<unsigned int>           l1bits3         (new unsigned int);
    auto_ptr<unsigned int>           l1bits4         (new unsigned int);
    auto_ptr<vector<TString> >       l1trigNames     (new vector<TString>);
    auto_ptr<int>                    l1nmus          (new int);
    auto_ptr<int>                    l1nemiso        (new int);
    auto_ptr<int>                    l1nemnoiso      (new int);
    auto_ptr<int>                    l1njetsc        (new int);
    auto_ptr<int>                    l1njetsf        (new int);
    auto_ptr<int>                    l1njetst        (new int);
