// -*- C++ -*-
// $Id: ElESIsoMaker.cc,v 1.4 2010/03/18 02:11:58 kalavase Exp $
...
ElESIsoMaker::ElESIsoMaker(const edm::ParameterSet& iConfig) {
  ...
  produces<std::vector<float> >  (branchprefix+"esJuraIso03").setBranchAlias(aliasprefix_+"_esJuraIso03");
  produces<std::vector<float> >  (branchprefix+"esJuraIso04").setBranchAlias(aliasprefix_+"_esJuraIso04");
  produces<std::vector<float> >  (branchprefix+"esJuraVeto").setBranchAlias(aliasprefix_+"_esJuraVeto");
...
void ElESIsoMaker::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  iEvent.put(els_esJuraIso03, branchprefix+"esJuraIso03");
  iEvent.put(els_esJuraIso04, branchprefix+"esJuraIso04");
  iEvent.put(els_esJuraVeto, branchprefix+"esJuraVeto");
