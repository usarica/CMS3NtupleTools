...
#kt6CaloJetsForMuHLTRhoMaker = cms.EDProducer("EnergyDensityMaker",
#                                             input = cms.InputTag("kt6CaloJetsForMuHLT","rho"),
#                                             alias = cms.untracked.string("evt_kt6calo_muhlt_rho"))
